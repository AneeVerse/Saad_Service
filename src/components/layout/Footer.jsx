      ...
      <footer className="bg-blue-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            {/* About Section */}
            <div>
              <h3 className="text-xl font-semibold mb-4">About Faad Service</h3>
              <p className="text-gray-300 text-sm leading-relaxed">
                Your trusted partner for document attestation, Apostille services, and more. Serving clients across 200+ countries with efficiency and reliability.
              </p>
            </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-4">
            <p className="text-center text-sm text-gray-400">
              &copy; {new Date().getFullYear()} Faad Service. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
