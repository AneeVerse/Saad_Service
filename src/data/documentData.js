const documentData = [
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Why Attestation is Important:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">Steps Involved:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Key Features:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Uses of Bonafide Certificate Attestation:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">How We Assist:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Why You Need Attestation for POA:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">How It Works:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Why Attestation is Needed:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">Steps in Attestation:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Importance of Attestation:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Why Legalization is Required:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">Process Involved:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">Steps in the Process:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-4">Uses of Attestation:</h3>
        <ul class="list-disc ml-6 pl-5 space-y-2 text-gray-600">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">Attestation Process:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
  ...
  },
  {
    ...
    details: 
      <div class="space-y-4">
        ...
        <h3 class="text-xl font-semibold text-gray-800 mt-6">How We Help:</h3>
        <ol class="list-decimal ml-6 pl-5 space-y-2 text-gray-600">
